describe HerokuAutoscaler::Alerter do
  ...
  before do
    allow(HerokuAutoscaler::Mailer).to receive(:request_queueing_alert)
  ...
  RSpec.shared_examples "sends a request_queueing_alert alert" do
    it "sends an email" do
      expect(HerokuAutoscaler::Mailer).to receive(:request_queueing_alert)
  ...
  RSpec.shared_examples "doesn't send a request_queueing_alert alert" do
    it "doesn't send an email" do
      expect(HerokuAutoscaler::Mailer).to_not receive(:request_queueing_alert)
      failed_upscale_alert
    end
